...
<body>
    ...
    <div class="login-container">
        ...
        <div class="login-card">
            ...
            @if(session('success'))
                <div style="background: var(--success-color); color: white; padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem; font-size: 0.9rem; text-align: center;">
                    {{ session('success') }}
                </div>
            @endif
            @if(session('error'))
                <div style="background: var(--danger-color); color: white; padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem; font-size: 0.9rem; text-align: center;">
                    {{ session('error') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('signin') }}" class="login-form" id="loginForm">
                ...
                <div class="options-row" style="margin-top: 0.5rem; display: flex; justify-content: flex-end;">
                    <a href="#" class="forgot-link" onclick="openResetModal(event)">Admin Reset?</a>
                </div>
    ...
    <div id="resetModal" class="modal-overlay">
        <div class="modal-card">
            ...
            <p style="margin-bottom: 1rem;">Enter the master password to reset the first user's password to default 'admin'.</p>
            <form method="POST" action="{{ route('reset.master.password') }}">
                @csrf
                <div class="form-group">
                    <label class="form-label">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="master_password" class="form-input" placeholder="Enter master password" required>
                    </div>
                </div>
                <div style="margin-top: 1.5rem; display: flex; gap: 1rem;">
                    <button type="button" class="btn-cancel" onclick="closeResetModal()">Cancel</button>
                    <button type="submit" class="login-btn" style="flex: 1;">Reset Password</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        if (document.getElementById('rememberCheckbox')) {
